...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-05-2026 a las 13:57:10
...
(6, '1006', 'manuel', 'Gonzales', 'manuel.gonzales@mail.com', '300000006', '0000-00-00'),
...
(1, 1, '2025-03-05', 'Caída', 'Resbalón en piso mojado', 'Primeros auxilios', '0000-00-00'),
(2, 2, '2025-03-12', 'Corte', 'Herida con herramienta', 'Curación', '2025-03-12'),
(3, 3, '2025-03-20', 'Golpe', 'Objeto cayó sobre brazo', 'Evaluación médica', '0000-00-00'),
...
(6, 6, '2025-04-12', 'Intoxicación', 'Inhalación de químicos', 'Atención médica', '0000-00-00'),
...
INSERT INTO `usuarios` (`ID_Usuario`, `ID_Empleado`, `Nombre_Usuario`, `Contrasena`, `Rol`, `Estado_Usuario`) VALUES
(1, 1, 'cristian.escobar', '123456', 'Administrador', 'Activo'),
(2, 2, 'jack.perez', '123456', 'Empleado', 'Activo'),
(3, 3, 'alejandro.zapata', '123456', 'Empleado', 'Activo');
...
ALTER TABLE `usuarios`
  ...
  ADD UNIQUE KEY `UK_Usuario_Empleado` (`ID_Empleado`);
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `FK_Usuario_Empleado` FOREIGN KEY (`ID_Empleado`) REFERENCES `empleados` (`ID_Empleado`) ON DELETE CASCADE;
COMMIT;
